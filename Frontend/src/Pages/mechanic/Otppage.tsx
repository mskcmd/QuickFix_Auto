...
import { verifyOtp } from '../../Api/mechanic';
...
const OTPComponent: React.FC = () => {
  const navigate = useNavigate();
    ...
    const handleVerify = async () => {
      ...
      console.log("fjsdhfjkds",result?.data.isUser);
      console.log("fjsdhfjkds",result?.data.isMechanic);
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen w-full bg-white">
            <div className="w-full max-w-md px-8 py-10 bg-white rounded-lg shadow-2xl transition-transform transform hover:scale-105">
                ...
                <p className="text-gray-600 text-center mb-4">Code sent tco your Email</p>
